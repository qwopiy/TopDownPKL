...
public class RangeAttackSO : AttackBehaviorSO
{
    ...
    public override void ExecuteAttack(GameObject attacker, Transform target, float damage)
    {
        ...
        GameObject bulletGO = Instantiate(projectilePrefabPlaceholder, new Vector3 (attacker.transform.position.x, attacker.transform.position.y + 1f, attacker.transform.position.z), attacker.transform.rotation);
